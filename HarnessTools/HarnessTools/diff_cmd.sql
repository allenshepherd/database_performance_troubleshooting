...
rem $Header$
rem $Name$          diff_cmd.sql

rem Copyright (c); 2005-2011 by Hotsos Enterprises, Ltd.
rem
rem Lists the resource statistics for two scenarios for
rem only the default statistics selected for display.
rem
rem Command line version of diff.sql
rem


set termout on heading off feedback off verify off

rem accept htst_workspace1 prompt '1st workspace: '
rem accept htst_scenario1  prompt '1st scenario : '
rem accept htst_workspace2 prompt '2nd workspace: '
rem accept htst_scenario2  prompt '2nd scenario : '

define htst_workspace1  = '&1'
define htst_scenario1   = '&2'
define htst_workspace2  = '&3'
define htst_scenario2   = '&4'
