...
rem
rem --- RVD this version has shortened columns for easier display on the screen
...
rem --- RVD added in these column commands to make the output fit better on screen
column name format a45
column difference format 999,999,999
column "&htst_workspace1:&htst_scenario1" format 999,999,999
column "&htst_workspace2:&htst_scenario2" format 999,999,999
rem --- RVD
