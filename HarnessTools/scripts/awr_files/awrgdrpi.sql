Rem
Rem $Header: rdbms/admin/awrgdrpi.sql /main/7 2017/05/28 22:46:00 stanaya Exp $
Rem
Rem awrgdrpi.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/awrgdrpi.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/awrgdrpi.sql
