...
Rem
Rem    NAME
Rem      sbrepcon.sql - StandBy statspack REPort CONfiguration
Rem
Rem    DESCRIPTION
...
Rem    SQL_SOURCE_FILE: rdbms/admin/sbrepcon.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sbrepcon.sql
Rem    SQL_PHASE: SBREPCON
Rem    SQL_STARTUP_MODE: NORMAL
Rem    SQL_IGNORABLE_ERRORS: NONE
Rem    END SQL_FILE_METADATA
Rem    
Rem    MODIFIED   (MM/DD/YY)
Rem    shsong      06/07/07 - Fix comments
Rem    wlohwass    12/04/06 - Created, based on sprepcon.sql
Rem
