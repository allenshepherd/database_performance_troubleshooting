Rem
Rem $Header: rdbms/admin/sqltrpt.sql /main/3 2017/05/28 22:46:11 stanaya Exp $
Rem
Rem sqltrpt.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/sqltrpt.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sqltrpt.sql
