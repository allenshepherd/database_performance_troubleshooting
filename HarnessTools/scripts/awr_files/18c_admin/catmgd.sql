Rem
Rem $Header: rdbms/admin/catmgd.sql /main/8 2017/05/28 22:46:02 stanaya Exp $
Rem
Rem catmgd.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catmgd.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catmgd.sql
...
Rem    hgong       04/28/16 - bug 23109575: lock user
Rem    hgong       03/02/16 - add call to sqlsessstart and sqlsessend
Rem    hgong       09/03/15 - Remove the calls to register MGD
