Rem
Rem $Header: rdbms/admin/dbmsspa.sql /main/20 2017/02/13 18:57:59 victlope Exp $
Rem
Rem dbmsspa.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsspa.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsspa.sql
Rem SQL_PHASE: DBMSSPA
...
Rem    kyagoub     01/12/17 - remote_proces_sql: add checksum arguments
Rem    zhcai       05/11/15 - add set_quick_check_task
Rem    aarvanit    12/08/14 - add support for imported AWR in analysis tasks
Rem    bhavenka    06/10/14 - pass params through XML in remote spa
Rem    surman      12/29/13 - 13922626: Update SQL metadata
Rem    surman      03/27/12 - 13615447: Add SQL patching tags
Rem    kyagoub     04/04/11 - add con_dbid to create_analysis_task
...
CREATE OR REPLACE PACKAGE dbms_sqlpa AUTHID CURRENT_USER AS
  ...
  -- quick check source constants
  QCHK_SOURCE_INITPARAM         CONSTANT VARCHAR2(20)
                                             := 'oneclick_init_params';
  QCHK_SOURCE_INDEX             CONSTANT VARCHAR2(21)  
                                             := 'oneclick_tuning_index';
  QCHK_SOURCE_STATS             CONSTANT VARCHAR2(22)  
                                             := 'oneclick_pending_stats';
  QCHK_SOURCE_SQLPROFILE        CONSTANT VARCHAR2(27)
                                             := 'oneclick_tuning_sql_profile';
  ...
  --
  -- DESCRIPTION
  --     This function is called to set a task to be a quick check task
  --
  -- PARAMETERS:
  --     task_id         (IN) - identifier of the task
  --     task_source     (IN) - the value for the source parameter, 
  --                            e.g., DBMS_SQLPA.QCHK_SOURCE_INITPARAM
  --
  -- EXCEPTIONS:
  --     
  -----------------------------------------------------------------------------
  PROCEDURE set_quick_check_task(
    task_id          IN NUMBER,
