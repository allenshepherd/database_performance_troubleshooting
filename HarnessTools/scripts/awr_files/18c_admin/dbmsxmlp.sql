Rem
Rem $Header: rdbms/admin/dbmsxmlp.sql /main/15 2014/02/20 12:46:25 surman Exp $
Rem
Rem dbmsxmlp.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsxmlp.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsxmlp.sql
Rem SQL_PHASE: DBMSXMLP
