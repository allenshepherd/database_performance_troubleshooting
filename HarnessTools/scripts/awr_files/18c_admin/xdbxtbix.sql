Rem
Rem $Header: rdbms/admin/xdbxtbix.sql /main/5 2017/05/28 22:46:13 stanaya Exp $
Rem
Rem xdbxtbix.sql
Rem
...
Rem
Rem    DESCRIPTION
Rem      Upgrade SXI from 11.2.0.1 and 11.2.0.2 -
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xdbxtbix.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xdbxtbix.sql
...
Rem    yinlu       07/31/14 - bug 19338057: do not repopulate SXI leaf table, 
Rem                           just populate KEY column
Rem    juding      02/23/11 - bug 11071061: add KEY column to SXI leaf table
Rem    juding      01/24/11 - bug 11070995: add OID column to SXI table
Rem                           created for partitioned xmltype table
