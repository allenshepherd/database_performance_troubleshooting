Rem
Rem $Header: rdbms/admin/xdbuuc.sql /main/10 2017/05/28 22:45:58 stanaya Exp $
Rem
Rem xdbuuc.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xdbuuc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xdbuuc.sql
