Rem
Rem $Header: rdbms/admin/catcmp.sql /main/9 2017/06/26 16:01:18 pjulsaks Exp $
Rem
Rem catcmp.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/catcmp.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/catcmp.sql
Rem SQL_PHASE: CATCMP
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON','CDB_COMPARISON');
grant select on SYS.CDB_comparison to select_catalog_role
/
create or replace public synonym CDB_comparison for SYS.CDB_comparison
/
...
CREATE OR REPLACE PUBLIC SYNONYM user_comparison
  FOR user_comparison
/
GRANT READ ON user_comparison TO public with GRANT OPTION
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON_COLUMNS','CDB_COMPARISON_COLUMNS');
grant select on SYS.CDB_comparison_columns to select_catalog_role
/
create or replace public synonym CDB_comparison_columns for SYS.CDB_comparison_columns
/
...
/
GRANT READ ON user_comparison_columns TO public with GRANT OPTION
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON_SCAN','CDB_COMPARISON_SCAN');
grant select on SYS.CDB_comparison_scan to select_catalog_role
/
create or replace public synonym CDB_comparison_scan for SYS.CDB_comparison_scan
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON_SCAN_SUMMARY','CDB_COMPARISON_SCAN_SUMMARY');
grant select on SYS.CDB_comparison_scan_summary to select_catalog_role
/
create or replace public synonym CDB_comparison_scan_summary for SYS.CDB_comparison_scan_summary
/
...
/
GRANT READ ON user_comparison_scan TO public with GRANT OPTION
/
...
/
GRANT READ ON user_comparison_scan_summary TO public with GRANT OPTION
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON_SCAN_VALUES','CDB_COMPARISON_SCAN_VALUES');
grant select on SYS.CDB_comparison_scan_values to select_catalog_role
/
create or replace public synonym CDB_comparison_scan_values for SYS.CDB_comparison_scan_values
/
...
/
GRANT READ ON user_comparison_scan_values TO public with GRANT OPTION
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_COMPARISON_ROW_DIF','CDB_COMPARISON_ROW_DIF');
grant select on SYS.CDB_comparison_row_dif to select_catalog_role
/
create or replace public synonym CDB_comparison_row_dif for SYS.CDB_comparison_row_dif
/
...
/
GRANT READ ON user_comparison_row_dif TO public with GRANT OPTION
/
...
GRANT READ ON "_USER_COMPARISON_ROW_DIF" TO public with GRANT OPTION
/
