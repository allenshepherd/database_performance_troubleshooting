...
Rem    SQL_SOURCE_FILE: rdbms/admin/odmdbmig.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/odmdbmig.sql
...
Rem       xbarr    28/04/11 - add odmu112.sql
...
ELSIF substr(dbms_registry.version('ODM'),1,6)='11.2.0' THEN
:file_name :='@odmu112.sql';
ELSE
:file_name :=dbms_registry.nothing_script;
END IF;
END;
