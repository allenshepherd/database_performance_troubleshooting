Rem
Rem $Header: rdbms/admin/dbmsbsln.sql /main/5 2014/02/20 12:45:50 surman Exp $
Rem
Rem dbmsbsln.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsbsln.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsbsln.sql
Rem SQL_PHASE: DBMSBSLN
