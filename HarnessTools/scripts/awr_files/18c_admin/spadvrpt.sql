Rem
Rem $Header: rdbms/admin/spadvrpt.sql /main/4 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem spadvrpt.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/spadvrpt.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/spadvrpt.sql
