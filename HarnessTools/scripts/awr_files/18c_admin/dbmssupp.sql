Rem
Rem $Header: rdbms/admin/dbmssupp.sql /main/2 2017/05/28 22:46:05 stanaya Exp $
Rem
Rem dbmssupp.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/dbmssupp.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/dbmssupp.sql
