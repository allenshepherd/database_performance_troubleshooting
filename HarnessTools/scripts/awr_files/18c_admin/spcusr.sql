Rem
Rem $Header: rdbms/admin/spcusr.sql /main/37 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem spcusr.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/spcusr.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/spcusr.sql
...
Rem    shsong      04/04/13 - Bug 16577065: filter query based on PDB con_id
