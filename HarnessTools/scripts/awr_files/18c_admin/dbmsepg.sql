Rem
Rem $Header: rdbms/admin/dbmsepg.sql /main/9 2014/02/20 12:45:54 surman Exp $
Rem
Rem dbmsepg.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsepg.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsepg.sql
Rem SQL_PHASE: DBMSEPG
