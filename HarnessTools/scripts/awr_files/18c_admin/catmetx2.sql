Rem
Rem $Header: rdbms/admin/catmetx2.sql /main/2 2017/05/28 22:46:02 stanaya Exp $
Rem
Rem catmetx2.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catmetx2.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catmetx2.sql
