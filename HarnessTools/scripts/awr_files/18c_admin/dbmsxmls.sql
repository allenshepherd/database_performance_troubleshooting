Rem
Rem $Header: rdbms/admin/dbmsxmls.sql /main/5 2014/02/20 12:46:27 surman Exp $
Rem
Rem dbmsxmls.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsxmls.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsxmls.sql
Rem SQL_PHASE: DBMSXMLS
...
Rem    jmuller     11/18/10 - Fix bug 8643797: compilation warnings
...
(
  ...
  overriding member procedure close (self in out nocopy XMLCharacterInputStream),
