Rem
Rem $Header: rdbms/admin/dbmsir.sql /st_rdbms_18.0/2 2018/05/01 21:53:42 apfwkr Exp $
Rem
Rem dbmsir.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsir.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsir.sql
Rem SQL_PHASE: DBMSIR
...
Rem    apfwkr      04/26/18 - Backport saratho_bug-27302681 from main
Rem    saratho     04/06/18 - Bug 27302681: restrict access only to rman
...
CREATE OR REPLACE PACKAGE dbms_ir AUTHID current_user AS
