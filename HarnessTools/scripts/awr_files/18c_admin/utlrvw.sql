Rem
Rem $Header: rdbms/admin/utlrvw.sql /main/5 2017/05/28 22:46:12 stanaya Exp $
Rem
Rem utlrvw.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/utlrvw.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/utlrvw.sql
...
Rem    sanagara    03/06/12 - Skip invalidation if fix for 6452863 is present
Rem    jaeblee     03/22/11 - Ignore views with $DEPRECATED$ subname
    ...
    SELECT o.obj#
      FROM obj$ o, user$ u 
        WHERE o.type#=4 AND u.user# = o.owner# AND o.obj# IN 
              ...
              (o.subname is null or o.subname <> '$DEPRECATED$') AND 
