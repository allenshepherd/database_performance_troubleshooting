Rem 
Rem $Header: rdbms/admin/dmproc.sql /main/11 2017/05/28 22:46:05 stanaya Exp $
Rem
Rem dmproc.sql
Rem 
...
Rem    SQL_SOURCE_FILE: rdbms/admin/dmproc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/dmproc.sql
...
Rem       amozes   10/14/14 - remove prvtdmar and prvtdmoc
Rem       qinwan   09/17/14 - call dbmsrqmo.sql
Rem       xbarr    06/01/11 - remove prvtdmab and its synonym 
Rem       xbarr    11/22/10 - bug#10011522 - remove prvtdmal
...
Rem Library, type, procedure definition (R Model)
