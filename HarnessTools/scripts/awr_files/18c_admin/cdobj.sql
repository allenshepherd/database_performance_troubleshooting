Rem
Rem $Header: rdbms/admin/cdobj.sql /main/26 2016/03/10 18:14:45 akruglik Exp $
Rem
Rem cdobj.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/cdobj.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/cdobj.sql
Rem SQL_PHASE: CDOBJ
...
Rem    skayoor     03/26/15 - Bug 20735308: Use ORA_CHECK_SYS_PRIVILEGE
Rem                           operator
...
Rem    thbaby      01/17/13 - 15827913 : fix *_DIRECTORIES to show linked obj
Rem    krajaman    10/15/12 - Use X$DIR
...
/
grant read on USER_NESTED_TABLE_COLS to PUBLIC with grant option
/
...
/
grant read on ALL_NESTED_TABLE_COLS to PUBLIC with grant option
/
