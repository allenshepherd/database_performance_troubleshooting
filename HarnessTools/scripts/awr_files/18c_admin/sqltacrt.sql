Rem
Rem $Header: rdbms/admin/sqltacrt.sql /main/2 2017/05/28 22:46:11 stanaya Exp $
Rem
Rem sqltacrt.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/sqltacrt.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sqltacrt.sql
