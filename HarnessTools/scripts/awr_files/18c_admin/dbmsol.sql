Rem
Rem $Header: rdbms/admin/dbmsol.sql /main/22 2017/04/26 16:07:31 cwidodo Exp $
Rem
Rem dbmsol.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsol.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsol.sql
Rem SQL_PHASE: DBMSOL
...
Rem    cwidodo     04/12/17 - #(25719642): Completely remove outln_edit_pkg
Rem    cwidodo     03/27/17 - #(25410921) : change package from Definer's Right
Rem                           to Invoker's Right
...
-- #(25410921): change package from Definers Right to Invokers Right. There
-- is a function (create_outline) that may cause privilege escalation issue
-- if it is evaluated in Definers Right package.

CREATE OR REPLACE PACKAGE sys.outln_pkg AUTHID CURRENT_USER as
