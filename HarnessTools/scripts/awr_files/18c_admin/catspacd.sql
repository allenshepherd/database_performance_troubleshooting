Rem
Rem $Header: rdbms/admin/catspacd.sql /main/3 2017/05/28 22:46:03 stanaya Exp $
Rem
Rem catspaced.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catspacd.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catspacd.sql
