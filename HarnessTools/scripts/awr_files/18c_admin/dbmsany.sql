Rem
Rem $Header: rdbms/admin/dbmsany.sql /main/21 2017/07/13 14:43:08 skabraha Exp $
Rem
Rem dbmsany.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsany.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsany.sql
Rem SQL_PHASE: DBMSANY
...
Rem    skabraha    06/29/17 - Moving GetPersistent out of AnyType definition
...
-- Type SYS.AnyType.
CREATE TYPE ANYTYPE OID '00000000000000000000000000020010'
AS OPAQUE VARYING (*)
...
/* We are making GetPersistent a standalone function, for it to work
   properly.
*/
/* NAME
   ...
   PARAMETERS
    ...
    EXCEPTIONS
 */
Create or Replace Function GetAnyTypeFromPersistent
...
GRANT EXECUTE ON  GetAnyTypeFromPersistent TO public
/

CREATE OR REPLACE PUBLIC SYNONYM GetAnyTypeFromPersistent for
SYS.GetAnyTypeFromPersistent
/
...
CREATE TYPE AnyData OID '00000000000000000000000000020011'
as OPAQUE VARYING (*)
...
CREATE TYPE AnyDataSet OID '00000000000000000000000000020012'
as OPAQUE VARYING (*)
