Rem $Header: rdbms/admin/dbmslob.sql /main/34 2016/08/15 22:06:42 srtata Exp $
Rem
Rem dbmslob.sql
Rem 
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmslob.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmslob.sql
Rem SQL_PHASE: DBMSLOB
...
Rem    srtata      07/28/16 - XbranchMerge srtata_bug-24310827 from
Rem                           st_rdbms_12.2.0.1.0
Rem    srtata      07/18/16 - bug 24310827: make variables constant
Rem    srtata      04/11/16 - bug 23087107: add isremote
Rem    snechand    07/01/15 - bug 21385830 - implementing clob2file in C
Rem    surman      12/29/13 - 13922626: Update SQL metadata
Rem    prthiaga    11/25/13 - Proj 47294: Add clob2file to dbms_lob package
 ...
 */
  ...
  FUNCTION isremote(lob_loc IN CLOB CHARACTER SET ANY_CS)
    RETURN BOOLEAN;
    PRAGMA RESTRICT_REFERENCES(isremote, WNDS, RNDS, WNPS, RNPS);
