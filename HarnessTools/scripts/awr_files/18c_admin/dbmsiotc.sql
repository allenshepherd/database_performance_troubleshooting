Rem
Rem $Header: rdbms/admin/dbmsiotc.sql /main/6 2017/05/28 22:46:04 stanaya Exp $
Rem
Rem dbmsiotc.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/dbmsiotc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/dbmsiotc.sql
