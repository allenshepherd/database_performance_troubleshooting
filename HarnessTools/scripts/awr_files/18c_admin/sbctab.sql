...
Rem    SQL_SOURCE_FILE: rdbms/admin/sbctab.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sbctab.sql
...
Rem    kchou       08/19/15 - Bug# 20445666 - Change object_alias type to
Rem                           varchar2(261) to support long identifiers in
Rem                           DB12.2
Rem    zhefan      10/27/14 - bug-19857877
Rem    pmurthy     02/20/14 - To Fix Bugs - 18284201 and 18273117
...
Rem    kchou       01/10/11 - Forward Merge of Bug Fix 9800868 to 12.1 Mainline
Rem    kchou       01/10/11 - XbranchMerge kchou_bug-9800868 from
Rem                           st_rdbms_11.2.0
Rem    kchou       01/06/11 - Bug# 9800868 - Forward Merge to Mainline Label:
Rem                           RDBMS_MAIN_LINUX.X64
Rem    kchou       01/06/11 - XbranchMerge kchou_bug-9800868 from main
...
Rem    kchou       09/01/10 - Bug#10076263 - Remove synonym STATS$IDLE_EVENT
Rem                           from sbctab.sql
Rem    kchou       06/10/10 - Bug# 9695145 Add Missing Idle Events to StandBy
Rem                           Statspack
Rem    kchou       06/09/10 - Bug# 9695145 - Add Missing Idle Events to Standby
Rem                           Statspack
...
,dst_queue_schema               varchar2(128)  not null
,dst_queue_name                 varchar2(128)  not null
,startup_time                   date
,total_msgs                     number
,total_bytes                    number
...
,db_unique_name                 varchar2(30)  not null
,instance_name                  varchar2(16)  not null
,src_queue_schema               varchar2(128)  not null
,src_queue_name                 varchar2(128)  not null
...
,constraint STATS$DYNAMIC_REM_STATS_PK primary key 
     (snap_id, db_unique_name, instance_name, remaster_type)
 using index tablespace &&tablespace_name
   storage (initial 1m next 1m pctincrease 0)
