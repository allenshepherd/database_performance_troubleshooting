Rem
Rem $Header: rdbms/admin/xsu102.sql /main/25 2017/05/28 22:46:14 stanaya Exp $
Rem
Rem xsu102.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xsu102.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xsu102.sql
...
Rem    yiru        12/11/08 - Create xs$principals table immediately after the
Rem                           new schema is registered and misc. fixups
Rem    rbhatti     11/25/08 - Register roleset schema as binary
