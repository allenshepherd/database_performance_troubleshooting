Rem
Rem $Header: rdbms/admin/dbmsjdev.sql /main/1 2016/02/03 19:33:48 mlfallon Exp $
Rem
Rem dbmsjdev.sql
Rem
...
Rem    mlfallon    01/27/16 - Adding DBMS_JAVASCRIPT to revoke list
  ...
  begin
    ...
    where grantee='PUBLIC' and owner='SYS' and privilege='EXECUTE' 
      and table_name in ('DBMS_JAVA','DBMS_JAVA_TEST','SQLJUTL','SQLJUTL2',
                         'JVMRJBCINV','DBMS_JAVA_MISC','DBMS_JAVASCRIPT');
