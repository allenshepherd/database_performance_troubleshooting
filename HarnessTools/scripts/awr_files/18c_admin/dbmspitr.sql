Rem
Rem $Header: rdbms/admin/dbmspitr.sql /main/5 2016/08/05 11:45:38 jingzhen Exp $
Rem
Rem dbmspitr.sql
Rem
Rem Copyright (c) 1996, 2016, Oracle and/or its affiliates. 
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmspitr.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmspitr.sql
Rem SQL_PHASE: DBMSPITR
