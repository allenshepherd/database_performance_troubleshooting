set echo off
Rem
Rem $Header: rdbms/admin/utlsyxsz.sql /main/5 2017/05/28 22:46:13 stanaya Exp $
Rem
Rem utlsyxsz.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/utlsyxsz.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/utlsyxsz.sql
