rem 
rem $Header: rdbms/admin/utllockt.sql /main/6 2017/05/28 22:46:12 stanaya Exp $ locktree.sql 
rem 
...
Rem    SQL_SOURCE_FILE: rdbms/admin/utllockt.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/utllockt.sql
...
Rem    
Rem  MODIFIED
Rem     vsegundo   03/25/14  - Change use of synomym to avoid ORA-01775 error
