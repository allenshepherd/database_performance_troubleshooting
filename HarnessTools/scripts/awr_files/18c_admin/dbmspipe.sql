rem
rem $Header: rdbms/admin/dbmspipe.sql /main/14 2014/02/20 12:45:52 surman Exp $
rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmspipe.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmspipe.sql
