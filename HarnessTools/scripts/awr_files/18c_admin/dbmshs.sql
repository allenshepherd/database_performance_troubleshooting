Rem
Rem $Header: rdbms/admin/dbmshs.sql /main/6 2016/08/12 08:32:24 esmendoz Exp $
Rem
Rem dbmshs.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmshs.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmshs.sql
Rem SQL_PHASE: DBMSHS
Rem SQL_STARTUP_MODE: NORMAL
Rem SQL_IGNORABLE_ERRORS: NONE
Rem SQL_CALLING_FILE: rdbms/admin/caths.sql
...
create or replace package "DBMS_HS" as
  ...
  miss_base_caps_num constant number := -24274;
  miss_base_caps_msg constant varchar2(76) := 'HS$_BASE_CAPS';

  dupl_base_caps exception;           
  pragma exception_init(dupl_base_caps, -24270);
  dupl_base_caps_num constant number := -24270;
  dupl_base_caps_msg constant varchar2(76) := 'HS$_BASE_CAPS';

  miss_base_dd exception;             
  pragma exception_init(miss_base_dd, -24274);  
  miss_base_dd_num constant number := -24274;  
  miss_base_dd_msg constant varchar2(76) := 'HS$_BASE_DD';    

  dupl_base_dd exception;             
  pragma exception_init(dupl_base_dd, -24270);  
  dupl_base_dd_num constant number := -24270;  
  dupl_base_dd_msg constant varchar2(76) := 'HS$_BASE_DD';    

  miss_class_caps exception;          
  pragma exception_init(miss_class_caps, -24274);        
  miss_class_caps_num constant number := -24274;         
  miss_class_caps_msg constant varchar2(76) := 'HS$_CLASS_CAPS';         

  dupl_class_caps exception;          
  pragma exception_init(dupl_class_caps, -24270);        
  dupl_class_caps_num constant number := -24270;         
  dupl_class_caps_msg constant varchar2(76) := 'HS$_CLASS_CAPS';          

  miss_class_dd exception;            
  pragma exception_init(miss_class_dd, -24274); 
  miss_class_dd_num constant number := -24274; 
  miss_class_dd_msg constant varchar2(76) := 'HS$_CLASS_DD';  

  dupl_class_dd exception;            
  pragma exception_init(dupl_class_dd, -24270); 
  dupl_class_dd_num constant number := -24270; 
  dupl_class_dd_msg constant varchar2(76) := 'HS$_CLASS_DD';  

  bad_TRANSLATION_TYPE exception;     
  pragma exception_init(bad_TRANSLATION_TYPE, -24271);   
  bad_TRANSLATION_TYPE_num constant number := -24271;    
  bad_TRANSLATION_TYPE_msg constant varchar2(76) := 'NULL';  
  
  bad_TRANSLATION_TEXT exception;
  pragma exception_init(bad_TRANSLATION_TEXT, -24273);   
  bad_TRANSLATION_TEXT_num constant number := -24273;    
  bad_TRANSLATION_TEXT_msg constant varchar2(76) := 'NULL';  

  miss_class_init exception;          
  pragma exception_init(miss_class_init, -24274);        
  miss_class_init_num constant number := -24274;         
  miss_class_init_msg constant varchar2(76) := 'HS$_CLASS_INIT';         

  dupl_class_init exception;          
  pragma exception_init(dupl_class_init, -24270);        
  dupl_class_init_num constant number := -24270;         
  dupl_class_init_msg constant varchar2(76) := 'HS$_CLASS_INIT';          

  bad_INIT_VALUE_TYPE exception;      
  pragma exception_init(bad_INIT_VALUE_TYPE, -24272);    
  bad_INIT_VALUE_TYPE_num constant number := -24272;     
  bad_INIT_VALUE_TYPE_msg constant varchar2(76) := 'NULL';   

  miss_fds_class exception;           
  pragma exception_init(miss_fds_class, -24274);
  miss_fds_class_num constant number := -24274;
  miss_fds_class_msg constant varchar2(76) := 'HS$_FDS_CLASS';

  dupl_fds_class exception;           
  pragma exception_init(dupl_fds_class, -24270);
  dupl_fds_class_num constant number := -24270;
  dupl_fds_class_msg constant varchar2(76) := 'HS$_FDS_CLASS';

  miss_fds_inst exception;            
  pragma exception_init(miss_fds_inst, -24274); 
  miss_fds_inst_num constant number := -24274; 
  miss_fds_inst_msg constant varchar2(76) := 'HS$_FDS_INST';  

  dupl_fds_inst exception;            
  pragma exception_init(dupl_fds_inst, -24270); 
  dupl_fds_inst_num constant number := -24270; 
  dupl_fds_inst_msg constant varchar2(76) := 'HS$_FDS_INST';  

  miss_inst_caps exception;           
  pragma exception_init(miss_inst_caps, -24274);
  miss_inst_caps_num constant number := -24274;
  miss_inst_caps_msg constant varchar2(76) := 'HS$_INST_CAPS';

  dupl_inst_caps exception;           
  pragma exception_init(dupl_inst_caps, -24270);
  dupl_inst_caps_num constant number := -24270;
  dupl_inst_caps_msg constant varchar2(76) := 'HS$_INST_CAPS';

  miss_inst_dd exception;             
  pragma exception_init(miss_inst_dd, -24274);  
  miss_inst_dd_num constant number := -24274;  
  miss_inst_dd_msg constant varchar2(76) := 'HS$_INST_DD';    

  dupl_inst_dd exception;             
  pragma exception_init(dupl_inst_dd, -24270);  
  dupl_inst_dd_num constant number := -24270;  
  dupl_inst_dd_msg constant varchar2(76) := 'HS$_INST_DD';    

  miss_inst_init exception;
  pragma exception_init(miss_inst_init, -24274);
  miss_inst_init_num constant number := -24274;
  miss_inst_init_msg constant varchar2(76) := 'HS$_INST_INIT';

  dupl_inst_init exception;           
  pragma exception_init(dupl_inst_init, -24270);
  dupl_inst_init_num constant number := -24270;
  dupl_inst_init_msg constant varchar2(76) := 'HS$_INST_INIT';
 --------------------------------
  -- Public procedures
  -- 
