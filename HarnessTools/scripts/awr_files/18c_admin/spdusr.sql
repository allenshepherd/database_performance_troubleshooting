Rem
Rem $Header: rdbms/admin/spdusr.sql /main/16 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem spdusr.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/spdusr.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/spdusr.sql
