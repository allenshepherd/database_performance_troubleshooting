...
Rem     mmuppago   05/22/06  - Changes to comply with XHTML req. from Portal 
...
is
   ...
   procedure signature(cname in varchar2 character set any_cs);
   ...
   /************************************************************************/
   function validate_arg(param in varchar2 character set any_cs) return varchar2;
