Rem
Rem $Header: rdbms/admin/catalog.sql /main/716 2017/05/26 05:12:29 raeburns Exp $ catalog.sql
Rem
...
Rem
Rem MODIFIED
Rem     raeburns   05/17/17  - Bug 25906282: Use SQL_DRIVER_ONLY
Rem     prakumar   01/19/17  - Proj 61375: Add catptt.sql
...
Rem     awitkows   04/11/11  - add cdclst.sql
...
Rem     araghava   10/25/04 - 3448802: do not use partobj$ to get blocksize in 
Rem                           *_LOBS 
...
Rem     tcheng     06/01/96 -  do not show hidden cols in *_updatable_columns
...
Rem     achaudhr   04/08/96 -  reorder decodes to eliminate to_numbers
...
Rem     jwijaya    05/26/92 -  fix bug 110884 - do not grant on v$sga
...
--CATCTL -S -D "Catalog Core SQL"    Initial scripts single process
@@cdstrt.sql
@@cdfixed.sql
@@catcdbviews.sql
@@catblock.sql
...
--CATCTL -R
--CATCTL -M -D "Catalog Tables and Views"
@@cdplsql.sql
@@cdsqlddl.sql
@@cdmanage.sql
@@cdtxnspc.sql
...
--CATCTL -R
--CATCTL -S -D "Catalog Final Scripts"   Final scripts single process
@@catptt.sql
@@catldr.sql
@@cdoptim.sql
@@catsum.sql
