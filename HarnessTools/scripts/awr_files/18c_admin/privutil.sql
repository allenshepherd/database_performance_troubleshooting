...
Rem     cvanes     01/17/17 - 23633556 Bump the version number to 11.2.0.0.1
...
Rem     klrice     07/22/10 - fixing bug # 9774695
Rem     mmuppago   04/07/09 - bumping up version 
Rem     aimmanue    02/05/08 - Bump up owa version for next release
...
Rem     mmuppago   03/21/06  - bumping up version 
Rem     akatti     12/20/05  - Bug 4739895 handle other types in who_called_me 
Rem     akatti     11/07/05  - Bug fix 4722130 validate before writing http 
Rem                            headers
...
create or replace package body OWA_UTIL is
   ...
   owa_version CONSTANT varchar2(64) := '11.2.0.0.1';
   ...
   function validate_arg(
       param in varchar2 character set any_cs 
   ) return varchar2 is
