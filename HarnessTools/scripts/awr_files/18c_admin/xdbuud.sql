Rem
Rem $Header: rdbms/admin/xdbuud.sql /main/6 2017/05/28 22:45:59 stanaya Exp $
Rem
Rem xdbuud.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xdbuud.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xdbuud.sql
