Rem
Rem $Header: rdbms/admin/dbmstrns.sql /main/3 2014/02/20 12:45:51 surman Exp $
Rem
Rem dbmstrns.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmstrns.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmstrns.sql
Rem SQL_PHASE: DBMSTRNS
