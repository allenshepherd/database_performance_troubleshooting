Rem
Rem $Header: rdbms/admin/sprepcon.sql /main/9 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem sprepcon.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/sprepcon.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sprepcon.sql
Rem    SQL_PHASE: SPREPCON
