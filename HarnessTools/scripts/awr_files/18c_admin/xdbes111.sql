Rem
Rem $Header: rdbms/admin/xdbes111.sql /main/20 2017/05/28 22:45:59 stanaya Exp $
Rem
Rem xdbes111.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xdbes111.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xdbes111.sql
...
Rem    qyu         04/04/17 - 25070346: drop synonym
Rem    dmelinge    04/06/12 - Upgrade IP hostname, bug 13917375
Rem    juding      07/29/11 - bug 12622803: invoke xdbes112.sql
Rem    vhosur      03/01/11 - Downgrade changes for FTP host name
...
select 'End of xdbes111 @ ' || to_char(sysdate, 'Dy DD-Mon-YYYY HH24:MI:SS') 
    as "FlushSession Timestamp" from dual;
