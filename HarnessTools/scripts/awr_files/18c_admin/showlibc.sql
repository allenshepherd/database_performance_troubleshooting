Rem
Rem $Header: rdbms/admin/showlibc.sql /main/2 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem showlibc.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/showlibc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/showlibc.sql
