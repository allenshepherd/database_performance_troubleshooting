rem
rem $Header: plsql/admin/pistub.sql /main/26 2014/02/20 12:45:57 surman Exp $
rem
...
Rem SQL_SOURCE_FILE: plsql/admin/pistub.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/pistub.sql
Rem SQL_PHASE: PISTUB
