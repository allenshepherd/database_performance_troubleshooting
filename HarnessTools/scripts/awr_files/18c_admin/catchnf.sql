Rem
Rem $Header: rdbms/admin/catchnf.sql /main/20 2016/03/22 06:48:13 raeburns Exp $
Rem
Rem catchnf.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/catchnf.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/catchnf.sql
Rem SQL_PHASE: CATCHNF
...
Rem                           CASCADE
Rem    amullick    09/04/15 - Bug20746256: alter type table_name and callback
...
create type sys.chnf$_reg_info_oc4j as object (
...
create type sys.chnf$_reg_info as object (
...
create type chnf$_desc as object(
...
execute CDBView.create_cdbview(false,'SYS','DBA_CHANGE_NOTIFICATION_REGS','CDB_CHANGE_NOTIFICATION_REGS');
grant select on SYS.CDB_CHANGE_NOTIFICATION_REGS to select_catalog_role
/
create or replace public synonym CDB_CHANGE_NOTIFICATION_REGS for SYS.CDB_CHANGE_NOTIFICATION_REGS
/
...
/
grant read on USER_CHANGE_NOTIFICATION_REGS to public with grant option
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_CQ_NOTIFICATION_QUERIES','CDB_CQ_NOTIFICATION_QUERIES');
grant select on SYS.CDB_CQ_NOTIFICATION_QUERIES to select_catalog_role
/
create or replace public synonym CDB_CQ_NOTIFICATION_QUERIES for SYS.CDB_CQ_NOTIFICATION_QUERIES
/
...
/
grant read on USER_CQ_NOTIFICATION_QUERIES to public with grant option
/                                               
