Rem
Rem $Header: rdbms/admin/mgdview.sql /main/6 2017/05/28 22:46:07 stanaya Exp $
Rem
Rem mgdview.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/mgdview.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/mgdview.sql
Rem    SQL_PHASE: MGDVIEW
