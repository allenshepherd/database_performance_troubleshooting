Rem
Rem $Header: rdbms/admin/dbmsasrt.sql /main/5 2016/08/22 11:15:00 lvbcheng Exp $
Rem
Rem dbmsasrt.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsasrt.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsasrt.sql
Rem SQL_PHASE: DBMSASRT
...
Rem    lvbcheng   08/16/16 - Documentation
...
create or replace package DBMS_ASSERT AUTHID CURRENT_USER is
  ...
  -- ENQUOTE_NAME
  --
  -- This function encloses the string argument in double quotes. 
  -- No additional quotes are added if the string was already in quotes.  
  -- The quoted string is then checked to see if it is a valid (quoted)
  -- simple sql name.
  --
