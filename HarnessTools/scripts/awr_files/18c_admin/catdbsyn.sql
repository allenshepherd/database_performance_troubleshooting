rem 
rem $Header: rdbms/admin/catdbsyn.sql /main/5 2017/05/28 22:46:01 stanaya Exp $ 
rem 
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catdbsyn.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catdbsyn.sql
