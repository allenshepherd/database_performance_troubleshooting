...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsxidx.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsxidx.sql
Rem SQL_PHASE: DBMSXIDX
...
Rem    yinlu       05/31/16 - bug 23492966: change default to current user
Rem    surman      01/23/14 - 13922626: Update SQL metadata
Rem    qyu         03/18/13 - Common start and end scripts
Rem    sipatel     05/15/11 - #(12360609)-add error_row_count out param for
Rem                           process_pending
Rem    sipatel     04/18/11 - #(12360609)-add pending_row_count out param for
Rem                           process_pending
Rem    attran      02/08/11 - 10366960: obsolete gather/delete_table_stats
Rem    sipatel     01/04/10 - #(11067798)-change supplemental logging pragma
Rem    sipatel     01/04/10 - #(1168604)-add process_pending
...
----------------------------------------------------------------------------
PROCEDURE SyncIndex(xml_index_schema IN VARCHAR2 default 
                      SYS_CONTEXT('USERENV','CURRENT_USER'),
                    xml_index_name   IN VARCHAR2,
