rem
rem $Header: plsql/admin/pipidl.sql /main/18 2014/02/20 12:45:56 surman Exp $
rem
...
Rem SQL_SOURCE_FILE: plsql/admin/pipidl.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/pipidl.sql
Rem SQL_PHASE: PIPIDL
