Rem
Rem $Header: rdbms/admin/catawrcdbvw.sql /st_rdbms_18.0/4 2018/03/27 07:00:31 kmorfoni Exp $
Rem
Rem catawrcdbvw.sql
Rem
...
Rem
Rem    NAME
Rem      catawrcdbvw.sql - Catalog script for AWR CDB Views
Rem
Rem    DESCRIPTION
Rem      Catalog script for AWR CDB Views. Used to create the
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catawrcdbvw.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catawrcdbvw.sql
Rem    SQL_PHASE: CATAWRCDBVW
...
Rem    kmorfoni    12/21/17 - Mask system data in AWR_CDB_DATABASE_INSTANCE
Rem    kmorfoni    12/13/17 - Bug 26405015: Fix for AWR_CDB_SEG_STAT
Rem    osuro       11/28/17 - Created
Rem

@@?/rdbms/admin/sqlsessstart.sql

Rem *************************************************************************
Rem Creating the Workload Repository Root (AWR_CDB) Catalog Views ...
Rem *************************************************************************
...
create or replace view AWR_CDB_DATABASE_INSTANCE
...
comment on table AWR_CDB_DATABASE_INSTANCE is
'Database Instance Information'
/
create or replace public synonym AWR_CDB_DATABASE_INSTANCE
    for AWR_CDB_DATABASE_INSTANCE
/
grant select on AWR_CDB_DATABASE_INSTANCE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SNAPSHOT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SNAPSHOT is
'Snapshot Information'
/
create or replace public synonym AWR_CDB_SNAPSHOT
    for AWR_CDB_SNAPSHOT
/
grant select on AWR_CDB_SNAPSHOT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SNAP_ERROR
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SNAP_ERROR is
'Snapshot Error Information'
/
create or replace public synonym AWR_CDB_SNAP_ERROR
    for AWR_CDB_SNAP_ERROR
/
grant select on AWR_CDB_SNAP_ERROR to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_COLORED_SQL
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_COLORED_SQL is
'Marked SQLs for snapshots'
/
create or replace public synonym AWR_CDB_COLORED_SQL
    for AWR_CDB_COLORED_SQL
/
grant select on AWR_CDB_COLORED_SQL to SELECT_CATALOG_ROLE
/
 ...
 ***************************************/
create or replace view AWR_CDB_BASELINE_METADATA
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_BASELINE_METADATA is
'Baseline Metadata Information'
/
create or replace public synonym AWR_CDB_BASELINE_METADATA
    for AWR_CDB_BASELINE_METADATA
/
grant select on AWR_CDB_BASELINE_METADATA to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_BASELINE_TEMPLATE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_BASELINE_TEMPLATE is
'Baseline Template Information'
/
create or replace public synonym AWR_CDB_BASELINE_TEMPLATE
    for AWR_CDB_BASELINE_TEMPLATE
/
grant select on AWR_CDB_BASELINE_TEMPLATE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_WR_CONTROL
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_WR_CONTROL is
'Workload Repository Control Information'
/
create or replace public synonym AWR_CDB_WR_CONTROL
    for AWR_CDB_WR_CONTROL
/
grant select on AWR_CDB_WR_CONTROL to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_TABLESPACE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_TABLESPACE is
  'Tablespace Static Information'
/
create or replace public synonym AWR_CDB_TABLESPACE
    for AWR_CDB_TABLESPACE
/
grant select on AWR_CDB_TABLESPACE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_DATAFILE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_DATAFILE is
'Names of Datafiles'
/
create or replace public synonym AWR_CDB_DATAFILE for AWR_CDB_DATAFILE
/
grant select on AWR_CDB_DATAFILE to SELECT_CATALOG_ROLE
/
 ...
 *        AWR_CDB_FILESTATXS
 *****************************************/
create or replace view AWR_CDB_FILESTATXS
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_FILESTATXS is
'Datafile Historical Statistics Information'
/
create or replace public synonym AWR_CDB_FILESTATXS for AWR_CDB_FILESTATXS
/
grant select on AWR_CDB_FILESTATXS to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_TEMPFILE
container_data container_data_admit_null con_id_filter sharing=extended data
  (DBID, FILE#, CREATION_CHANGE#,
   FILENAME, TS#, TSNAME, BLOCK_SIZE, CON_DBID, CON_ID)
as
...
comment on table AWR_CDB_TEMPFILE is
'Names of Temporary Datafiles'
/
create or replace public synonym AWR_CDB_TEMPFILE for AWR_CDB_TEMPFILE
/
grant select on AWR_CDB_TEMPFILE to SELECT_CATALOG_ROLE
/
 ...
 *        AWR_CDB_TEMPSTATXS
 *****************************************/
create or replace view AWR_CDB_TEMPSTATXS
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   FILE#, CREATION_CHANGE#, FILENAME, TS#, TSNAME, BLOCK_SIZE,
   PHYRDS, PHYWRTS, SINGLEBLKRDS, READTIM, WRITETIM,
...
comment on table AWR_CDB_TEMPSTATXS is
'Temporary Datafile Historical Statistics Information'
/
create or replace public synonym AWR_CDB_TEMPSTATXS for AWR_CDB_TEMPSTATXS
/
grant select on AWR_CDB_TEMPSTATXS to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_COMP_IOSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_COMP_IOSTAT is
'I/O stats aggregated on component level'
/
create or replace public synonym AWR_CDB_COMP_IOSTAT
  for AWR_CDB_COMP_IOSTAT
/
grant select on AWR_CDB_COMP_IOSTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQLSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_SQLSTAT is
'SQL Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SQLSTAT for AWR_CDB_SQLSTAT
/
grant select on AWR_CDB_SQLSTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQLTEXT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQLTEXT is
'SQL Text'
/
create or replace public synonym AWR_CDB_SQLTEXT for AWR_CDB_SQLTEXT
/
grant select on AWR_CDB_SQLTEXT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQL_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQL_SUMMARY is
'Summary of SQL Statistics'
/
create or replace public synonym AWR_CDB_SQL_SUMMARY
   for AWR_CDB_SQL_SUMMARY
/
grant select on AWR_CDB_SQL_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQL_PLAN
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQL_PLAN is
'SQL Plan Information'
/
create or replace public synonym AWR_CDB_SQL_PLAN for AWR_CDB_SQL_PLAN
/
grant select on AWR_CDB_SQL_PLAN to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQL_BIND_METADATA
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQL_BIND_METADATA is
'SQL Bind Metadata Information'
/
create or replace public synonym AWR_CDB_SQL_BIND_METADATA
  for AWR_CDB_SQL_BIND_METADATA
/
grant select on AWR_CDB_SQL_BIND_METADATA to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_OPTIMIZER_ENV
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_OPTIMIZER_ENV is
'Optimizer Environment Information'
/
create or replace public synonym AWR_CDB_OPTIMIZER_ENV
   for AWR_CDB_OPTIMIZER_ENV
/
grant select on AWR_CDB_OPTIMIZER_ENV to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_EVENT_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_EVENT_NAME is
'Event Names'
/
create or replace public synonym AWR_CDB_EVENT_NAME for AWR_CDB_EVENT_NAME
/
grant select on AWR_CDB_EVENT_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SYSTEM_EVENT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_SYSTEM_EVENT is
'System Event Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SYSTEM_EVENT
    for AWR_CDB_SYSTEM_EVENT
/
grant select on AWR_CDB_SYSTEM_EVENT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CON_SYSTEM_EVENT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   EVENT_ID, EVENT_NAME, WAIT_CLASS_ID, WAIT_CLASS,
   TOTAL_WAITS, TOTAL_TIMEOUTS, TIME_WAITED_MICRO,
...
comment on table AWR_CDB_CON_SYSTEM_EVENT is
'System Event Historical Statistics Information'
/
create or replace public synonym AWR_CDB_CON_SYSTEM_EVENT
    for AWR_CDB_CON_SYSTEM_EVENT
/
grant select on AWR_CDB_CON_SYSTEM_EVENT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_BG_EVENT_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   EVENT_ID, EVENT_NAME, WAIT_CLASS_ID, WAIT_CLASS,
...
comment on table AWR_CDB_BG_EVENT_SUMMARY is
'Summary of Background Event Historical Statistics Information'
/
create or replace public synonym AWR_CDB_BG_EVENT_SUMMARY
   for AWR_CDB_BG_EVENT_SUMMARY
/
grant select on AWR_CDB_BG_EVENT_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CHANNEL_WAITS
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_CHANNEL_WAITS is
'Channel Waits Information'
/
create or replace public synonym AWR_CDB_CHANNEL_WAITS for AWR_CDB_CHANNEL_WAITS
/
grant select on AWR_CDB_CHANNEL_WAITS to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_WAITSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_WAITSTAT is
'Wait Historical Statistics Information'
/
create or replace public synonym AWR_CDB_WAITSTAT for AWR_CDB_WAITSTAT
/
grant select on AWR_CDB_WAITSTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_ENQUEUE_STAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_ENQUEUE_STAT is
'Enqueue Historical Statistics Information'
/
create or replace public synonym AWR_CDB_ENQUEUE_STAT
    for AWR_CDB_ENQUEUE_STAT
/
grant select on AWR_CDB_ENQUEUE_STAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LATCH_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_LATCH_NAME is
'Latch Names'
/
create or replace public synonym AWR_CDB_LATCH_NAME for AWR_CDB_LATCH_NAME
/
grant select on AWR_CDB_LATCH_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LATCH
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_LATCH is
'Latch Historical Statistics Information'
/
create or replace public synonym AWR_CDB_LATCH for AWR_CDB_LATCH
/
grant select on AWR_CDB_LATCH to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LATCH_CHILDREN
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_LATCH_CHILDREN is
'Latch Children Historical Statistics Information'
/
create or replace public synonym AWR_CDB_LATCH_CHILDREN
    for AWR_CDB_LATCH_CHILDREN
/
grant select on AWR_CDB_LATCH_CHILDREN to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LATCH_PARENT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   LATCH_HASH, LATCH_NAME, LEVEL#, GETS,
   MISSES, SLEEPS, IMMEDIATE_GETS, IMMEDIATE_MISSES, SPIN_GETS,
...
comment on table AWR_CDB_LATCH_PARENT is
'Latch Parent Historical Historical Statistics Information'
/
create or replace public synonym AWR_CDB_LATCH_PARENT
    for AWR_CDB_LATCH_PARENT
/
grant select on AWR_CDB_LATCH_PARENT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LATCH_MISSES_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_LATCH_MISSES_SUMMARY is
'Latch Misses Summary Historical Statistics Information'
/
create or replace public synonym AWR_CDB_LATCH_MISSES_SUMMARY
    for AWR_CDB_LATCH_MISSES_SUMMARY
/
grant select on AWR_CDB_LATCH_MISSES_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_EVENT_HISTOGRAM
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   EVENT_ID, EVENT_NAME, WAIT_CLASS_ID, WAIT_CLASS,
...
comment on table AWR_CDB_EVENT_HISTOGRAM is
'Event Histogram Historical Statistics Information'
/
create or replace public synonym AWR_CDB_EVENT_HISTOGRAM
    for AWR_CDB_EVENT_HISTOGRAM
/
grant select on AWR_CDB_EVENT_HISTOGRAM to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_MUTEX_SLEEP
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_MUTEX_SLEEP is
'Mutex Sleep Summary Historical Statistics Information'
/
create or replace public synonym AWR_CDB_MUTEX_SLEEP
    for AWR_CDB_MUTEX_SLEEP
/
grant select on AWR_CDB_MUTEX_SLEEP to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_LIBRARYCACHE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_LIBRARYCACHE is
'Library Cache Historical Statistics Information'
/
create or replace public synonym AWR_CDB_LIBRARYCACHE
    for AWR_CDB_LIBRARYCACHE
/
grant select on AWR_CDB_LIBRARYCACHE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_DB_CACHE_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_DB_CACHE_ADVICE is
'DB Cache Advice History Information'
/
create or replace public synonym AWR_CDB_DB_CACHE_ADVICE
    for AWR_CDB_DB_CACHE_ADVICE
/
grant select on AWR_CDB_DB_CACHE_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_BUFFER_POOL_STAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_BUFFER_POOL_STAT is
'Buffer Pool Historical Statistics Information'
/
create or replace public synonym AWR_CDB_BUFFER_POOL_STAT
    for AWR_CDB_BUFFER_POOL_STAT
/
grant select on AWR_CDB_BUFFER_POOL_STAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_ROWCACHE_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_ROWCACHE_SUMMARY is
'Row Cache Historical Statistics Information Summary'
/
create or replace public synonym AWR_CDB_ROWCACHE_SUMMARY
    for AWR_CDB_ROWCACHE_SUMMARY
/
grant select on AWR_CDB_ROWCACHE_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SGA
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SGA is
'SGA Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SGA for AWR_CDB_SGA
/
grant select on AWR_CDB_SGA to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SGASTAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SGASTAT is
'SGA Pool Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SGASTAT for AWR_CDB_SGASTAT
/
grant select on AWR_CDB_SGASTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PGASTAT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, NAME, VALUE, CON_DBID, CON_ID)
as
...
comment on table AWR_CDB_PGASTAT is
'PGA Historical Statistics Information'
/
create or replace public synonym AWR_CDB_PGASTAT for AWR_CDB_PGASTAT
/
grant select on AWR_CDB_PGASTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PROCESS_MEM_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_PROCESS_MEM_SUMMARY is
'Process Memory Historical Summary Information'
/
create or replace public synonym AWR_CDB_PROCESS_MEM_SUMMARY
   for AWR_CDB_PROCESS_MEM_SUMMARY
/
grant select on AWR_CDB_PROCESS_MEM_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_RESOURCE_LIMIT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_RESOURCE_LIMIT is
'Resource Limit Historical Statistics Information'
/
create or replace public synonym AWR_CDB_RESOURCE_LIMIT
    for AWR_CDB_RESOURCE_LIMIT
/
grant select on AWR_CDB_RESOURCE_LIMIT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SHARED_POOL_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SHARED_POOL_ADVICE is
'Shared Pool Advice History'
/
create or replace public synonym AWR_CDB_SHARED_POOL_ADVICE
    for AWR_CDB_SHARED_POOL_ADVICE
/
grant select on AWR_CDB_SHARED_POOL_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_STREAMS_POOL_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_STREAMS_POOL_ADVICE is
'Streams Pool Advice History'
/
create or replace public synonym AWR_CDB_STREAMS_POOL_ADVICE
    for AWR_CDB_STREAMS_POOL_ADVICE
/
grant select on AWR_CDB_STREAMS_POOL_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQL_WORKAREA_HSTGRM
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQL_WORKAREA_HSTGRM is
'SQL Workarea Histogram History'
/
create or replace public synonym AWR_CDB_SQL_WORKAREA_HSTGRM
    for AWR_CDB_SQL_WORKAREA_HSTGRM
/
grant select on AWR_CDB_SQL_WORKAREA_HSTGRM to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PGA_TARGET_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_PGA_TARGET_ADVICE is
'PGA Target Advice History'
/
create or replace public synonym AWR_CDB_PGA_TARGET_ADVICE
    for AWR_CDB_PGA_TARGET_ADVICE
/
grant select on AWR_CDB_PGA_TARGET_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SGA_TARGET_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SGA_TARGET_ADVICE is
'SGA Target Advice History'
/
create or replace public synonym AWR_CDB_SGA_TARGET_ADVICE
    for AWR_CDB_SGA_TARGET_ADVICE
/
grant select on AWR_CDB_SGA_TARGET_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_MEMORY_TARGET_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_MEMORY_TARGET_ADVICE is
'Memory Target Advice History'
/
create or replace public synonym AWR_CDB_MEMORY_TARGET_ADVICE
    for AWR_CDB_MEMORY_TARGET_ADVICE
/
grant select on AWR_CDB_MEMORY_TARGET_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_MEMORY_RESIZE_OPS
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_MEMORY_RESIZE_OPS is
'Memory Resize Operations History'
/
create or replace public synonym AWR_CDB_MEMORY_RESIZE_OPS
    for AWR_CDB_MEMORY_RESIZE_OPS
/
grant select on AWR_CDB_MEMORY_RESIZE_OPS to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_INSTANCE_RECOVERY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_INSTANCE_RECOVERY is
'Instance Recovery Historical Statistics Information'
/
create or replace public synonym AWR_CDB_INSTANCE_RECOVERY
    for AWR_CDB_INSTANCE_RECOVERY
/
grant select on AWR_CDB_INSTANCE_RECOVERY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_RECOVERY_PROGRESS
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_RECOVERY_PROGRESS is
'Recovery Progress'
/
create or replace public synonym AWR_CDB_RECOVERY_PROGRESS
    for AWR_CDB_RECOVERY_PROGRESS
/
grant select on AWR_CDB_RECOVERY_PROGRESS to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_JAVA_POOL_ADVICE
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_JAVA_POOL_ADVICE is
'Java Pool Advice History'
/
create or replace public synonym AWR_CDB_JAVA_POOL_ADVICE
    for AWR_CDB_JAVA_POOL_ADVICE
/
grant select on AWR_CDB_JAVA_POOL_ADVICE to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_THREAD
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_THREAD is
'Thread Historical Statistics Information'
/
create or replace public synonym AWR_CDB_THREAD
    for AWR_CDB_THREAD
/
grant select on AWR_CDB_THREAD to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_STAT_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_STAT_NAME is
'Statistic Names'
/
create or replace public synonym AWR_CDB_STAT_NAME for AWR_CDB_STAT_NAME
/
grant select on AWR_CDB_STAT_NAME to SELECT_CATALOG_ROLE
/
...
-- with awr_cdb_stat_name and awr_cdb_snapshoot
create or replace view AWR_CDB_SYSSTAT_ID
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_SYSSTAT_ID is
'System Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SYSSTAT_ID for AWR_CDB_SYSSTAT_ID
/
grant select on AWR_CDB_SYSSTAT_ID to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SYSSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_SYSSTAT is
'System Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SYSSTAT for AWR_CDB_SYSSTAT
/
grant select on AWR_CDB_SYSSTAT to SELECT_CATALOG_ROLE
/
 ...
 *    AWR_CDB_CON_SYSSTAT
 ***************************************/
create or replace view AWR_CDB_CON_SYSSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
   STAT_ID, STAT_NAME, VALUE, CON_DBID, CON_ID)
as
...
comment on table AWR_CDB_CON_SYSSTAT is
'System Historical Statistics Information Per PDB'
/
create or replace public synonym AWR_CDB_CON_SYSSTAT for AWR_CDB_CON_SYSSTAT
/
grant select on AWR_CDB_CON_SYSSTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SYS_TIME_MODEL
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SYS_TIME_MODEL is
'System Time Model Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SYS_TIME_MODEL
   for AWR_CDB_SYS_TIME_MODEL
/
grant select on AWR_CDB_SYS_TIME_MODEL to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CON_SYS_TIME_MODEL
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, STAT_ID, STAT_NAME, VALUE, CON_DBID, CON_ID)
as
select s.snap_id, s.dbid, s.instance_number, s.stat_id,
...
comment on table AWR_CDB_CON_SYS_TIME_MODEL is
'PDB System Time Model Historical Statistics Information'
/
create or replace public synonym AWR_CDB_CON_SYS_TIME_MODEL
   for AWR_CDB_CON_SYS_TIME_MODEL
/
grant select on AWR_CDB_CON_SYS_TIME_MODEL to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_OSSTAT_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
  (DBID, STAT_ID, STAT_NAME, CON_DBID, CON_ID)
as
select dbid, stat_id, stat_name,
...
comment on table AWR_CDB_OSSTAT_NAME is
'Operating System Statistic Names'
/
create or replace public synonym AWR_CDB_OSSTAT_NAME
  for AWR_CDB_OSSTAT_NAME
/
grant select on AWR_CDB_OSSTAT_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_OSSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, STAT_ID, STAT_NAME, VALUE, CON_DBID, CON_ID)
as
select s.snap_id, s.dbid, s.instance_number, s.stat_id,
...
comment on table AWR_CDB_OSSTAT is
'Operating System Historical Statistics Information'
/
create or replace public synonym AWR_CDB_OSSTAT
   for AWR_CDB_OSSTAT
/
grant select on AWR_CDB_OSSTAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PARAMETER_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_PARAMETER_NAME is
'Parameter Names'
/
create or replace public synonym AWR_CDB_PARAMETER_NAME
    for AWR_CDB_PARAMETER_NAME
/
grant select on AWR_CDB_PARAMETER_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PARAMETER
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_PARAMETER is
'Parameter Historical Statistics Information'
/
create or replace public synonym AWR_CDB_PARAMETER
    for AWR_CDB_PARAMETER
/
grant select on AWR_CDB_PARAMETER to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_MVPARAMETER
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, PARAMETER_HASH,
...
comment on table AWR_CDB_MVPARAMETER is
'Multi-valued Parameter Historical Statistics Information'
/
create or replace public synonym AWR_CDB_MVPARAMETER
    for AWR_CDB_MVPARAMETER
/
grant select on AWR_CDB_MVPARAMETER to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_UNDOSTAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_UNDOSTAT is
'Undo Historical Statistics Information'
/
create or replace public synonym AWR_CDB_UNDOSTAT
    for AWR_CDB_UNDOSTAT
/
grant select on AWR_CDB_UNDOSTAT to SELECT_CATALOG_ROLE
/
 ...
 *       in the AWR_CDB_SEG_STAT view in case any product has a
 ...
 *****************************************************************************/
create or replace view AWR_CDB_SEG_STAT
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SEG_STAT is
' Historical Statistics Information'
/
create or replace public synonym AWR_CDB_SEG_STAT
    for AWR_CDB_SEG_STAT
/
grant select on AWR_CDB_SEG_STAT to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SEG_STAT_OBJ
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SEG_STAT_OBJ is
'Segment Names'
/
create or replace public synonym AWR_CDB_SEG_STAT_OBJ
    for AWR_CDB_SEG_STAT_OBJ
/
grant select on AWR_CDB_SEG_STAT_OBJ to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_METRIC_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_METRIC_NAME is
'Segment Names'
/
create or replace public synonym AWR_CDB_METRIC_NAME
    for AWR_CDB_METRIC_NAME
/
grant select on AWR_CDB_METRIC_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SYSMETRIC_HISTORY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SYSMETRIC_HISTORY is
'System Metrics History'
/
create or replace public synonym AWR_CDB_SYSMETRIC_HISTORY
    for AWR_CDB_SYSMETRIC_HISTORY
/
grant select on AWR_CDB_SYSMETRIC_HISTORY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SYSMETRIC_SUMMARY
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, BEGIN_TIME, END_TIME, INTSIZE,
...
comment on table AWR_CDB_SYSMETRIC_SUMMARY is
'System Metrics History'
/
create or replace public synonym AWR_CDB_SYSMETRIC_SUMMARY
    for AWR_CDB_SYSMETRIC_SUMMARY
/
grant select on AWR_CDB_SYSMETRIC_SUMMARY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CON_SYSMETRIC_HIST
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, BEGIN_TIME, END_TIME, INTSIZE,
   GROUP_ID, METRIC_ID, METRIC_NAME, VALUE, METRIC_UNIT, CON_DBID, CON_ID)
as
...
comment on table AWR_CDB_CON_SYSMETRIC_HIST is
'PDB System Metrics History'
/
create or replace public synonym AWR_CDB_CON_SYSMETRIC_HIST
    for AWR_CDB_CON_SYSMETRIC_HIST
/
grant select on AWR_CDB_CON_SYSMETRIC_HIST to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CON_SYSMETRIC_SUMM
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER, BEGIN_TIME, END_TIME, INTSIZE,
   GROUP_ID, METRIC_ID, METRIC_NAME, METRIC_UNIT, NUM_INTERVAL,
   MINVAL, MAXVAL, AVERAGE, STANDARD_DEVIATION, SUM_SQUARES, CON_DBID, CON_ID)
...
comment on table AWR_CDB_CON_SYSMETRIC_SUMM is
'PDB System Metrics Summary'
/
create or replace public synonym AWR_CDB_CON_SYSMETRIC_SUMM
    for AWR_CDB_CON_SYSMETRIC_SUMM
/
grant select on AWR_CDB_CON_SYSMETRIC_SUMM to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SESSMETRIC_HISTORY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SESSMETRIC_HISTORY is
'System Metrics History'
/
create or replace public synonym AWR_CDB_SESSMETRIC_HISTORY
    for AWR_CDB_SESSMETRIC_HISTORY
/
grant select on AWR_CDB_SESSMETRIC_HISTORY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_FILEMETRIC_HISTORY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_FILEMETRIC_HISTORY is
'File Metrics History'
/
create or replace public synonym AWR_CDB_FILEMETRIC_HISTORY
    for AWR_CDB_FILEMETRIC_HISTORY
/
grant select on AWR_CDB_FILEMETRIC_HISTORY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_WAITCLASSMET_HISTORY
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_WAITCLASSMET_HISTORY is
'Wait Class Metric History'
/
create or replace public synonym AWR_CDB_WAITCLASSMET_HISTORY
    for AWR_CDB_WAITCLASSMET_HISTORY
/
grant select on AWR_CDB_WAITCLASSMET_HISTORY to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_DLM_MISC
container_data container_data_admit_null con_id_filter sharing=extended data
  (SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_DLM_MISC is
'Distributed Lock Manager Miscellaneous Historical Statistics Information'
/
create or replace public synonym AWR_CDB_DLM_MISC
    for AWR_CDB_DLM_MISC
/
grant select on AWR_CDB_DLM_MISC to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CR_BLOCK_SERVER
container_data container_data_admit_null con_id_filter sharing=extended data
(SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_CR_BLOCK_SERVER is
'Consistent Read Block Server Historical Statistics'
/
create or replace public synonym AWR_CDB_CR_BLOCK_SERVER
    for AWR_CDB_CR_BLOCK_SERVER
/
grant select on AWR_CDB_CR_BLOCK_SERVER to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_CURRENT_BLOCK_SERVER
container_data container_data_admit_null con_id_filter sharing=extended data
(SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_CURRENT_BLOCK_SERVER is
'Current Block Server Historical Statistics'
/
create or replace public synonym AWR_CDB_CURRENT_BLOCK_SERVER
    for AWR_CDB_CURRENT_BLOCK_SERVER
/
grant select on AWR_CDB_CURRENT_BLOCK_SERVER to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_INST_CACHE_TRANSFER
container_data container_data_admit_null con_id_filter sharing=extended data
(SNAP_ID, DBID, INSTANCE_NUMBER,
...
comment on table AWR_CDB_INST_CACHE_TRANSFER is
'Instance Cache Transfer Historical Statistics'
/
create or replace public synonym AWR_CDB_INST_CACHE_TRANSFER
    for AWR_CDB_INST_CACHE_TRANSFER
/
grant select on AWR_CDB_INST_CACHE_TRANSFER to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PLAN_OPERATION_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_PLAN_OPERATION_NAME is
'Optimizer Explain Plan Operation Names'
/
create or replace public synonym AWR_CDB_PLAN_OPERATION_NAME
  for AWR_CDB_PLAN_OPERATION_NAME
/
grant select on AWR_CDB_PLAN_OPERATION_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_PLAN_OPTION_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_PLAN_OPTION_NAME is
'Optimizer Explain Plan Option Names'
/
create or replace public synonym AWR_CDB_PLAN_OPTION_NAME
  for AWR_CDB_PLAN_OPTION_NAME
/
grant select on AWR_CDB_PLAN_OPTION_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_SQLCOMMAND_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_SQLCOMMAND_NAME is
'Sql command types'
/
create or replace public synonym AWR_CDB_SQLCOMMAND_NAME
  for AWR_CDB_SQLCOMMAND_NAME
/
grant select on AWR_CDB_SQLCOMMAND_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_TOPLEVELCALL_NAME
container_data container_data_admit_null con_id_filter sharing=extended data
...
comment on table AWR_CDB_TOPLEVELCALL_NAME is
'Oracle top level call type'
/
create or replace public synonym AWR_CDB_TOPLEVELCALL_NAME
  for AWR_CDB_TOPLEVELCALL_NAME
/
grant select on AWR_CDB_TOPLEVELCALL_NAME to SELECT_CATALOG_ROLE
/
...
create or replace view AWR_CDB_ACTIVE_SESS_HISTORY
container_data container_data_admit_null con_id_filter sharing=extended data
