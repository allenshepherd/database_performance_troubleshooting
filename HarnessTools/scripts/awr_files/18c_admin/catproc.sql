rem 
rem $Header: rdbms/admin/catproc.sql /main/278 2017/05/26 05:12:28 raeburns Exp $ 
rem 
...
Rem SQL_SOURCE_FILE: rdbms/admin/catproc.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/catproc.sql
Rem SQL_PHASE: CATPROC
...
Rem     frealvar   03/25/16 - Bug 22695570 clean up references to utluppkg.sql
Rem     raeburns   09/25/15 - RTI 16218614: move scripts to catptyps.sql
Rem     jerrede    07/27/15 - Add -D Description
Rem     surman     03/08/13 - 16462837: Common start and end scripts
Rem     jerrede    12/20/12 - Catcon Changes
Rem     bmccarth   12/11/12 - utluppkg.sql
...
Rem     jerrede    04/03/12 - Fix lrg 6849985 ORA-04063: package body
Rem                           SYS.DBMS_SCHEDULER has errors
Rem     msabesan   03/30/12 - catcdbviews.sql moved after catpdeps.sql
...
Rem     pyam       09/08/11 - set _ORACLE_SCRIPT
...
--CATCTL -S -D "Catproc Start"               Initial scripts single threaded
@@catpstrt.sql

--CATCTL -S -D "Catproc Types"               Public Types + Grants
@@catptyps.sql
@@catpgrants.sql

--CATCTL -R
--CATCTL -M -D "Catproc Tables"              Tables and views
@@catptabs.sql     --CATFILE -X  

--CATCTL -R
--CATCTL -S -D "Catproc Package Specs"       Package specs with dependents
@@catpspec.sql

--CATCTL -R
--CATCTL -M -D "Catproc Procedures"          Package specs, procedures, functions
@@catpdbms.sql     --CATFILE -X

--CATCTL -R
--CATCTL -M -D "Catproc Views"               Dependent views and indexes   
@@catpdeps.sql     --CATFILE -X

--CATCTL -R
--CATCTL -S -D "Catproc CDB Views" 
...
--CATCTL -R
--CATCTL -M  -D "Catproc SQL"               Anonymous PLSQL blocks
@@catpexec.sql     --CATFILE -X

--CATCTL -R
--CATCTL -S  -D "Final Catproc scripts"     Final scripts
@@catpend.sql
