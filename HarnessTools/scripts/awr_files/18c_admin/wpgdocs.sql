Rem
Rem $Header: wwg_src_1/admin/owa/wpgdocs.sql /main/10 2015/04/13 15:41:00 vtropash Exp $
Rem
Rem wpgdocs.sql
Rem
...
CREATE OR replace PACKAGE wpg_docload AUTHID CURRENT_USER
AS
...
--   Get the name and mime_type of the file to be downloaded
-- PARAMS:
--   p_doc_info      OUT: encoded document information in RAW format
--
