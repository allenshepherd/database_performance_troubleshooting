rem 
rem $Header: rdbms/admin/dbmsjob.sql /main/16 2014/05/14 09:16:11 claguna Exp $ 
rem 
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsjob.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsjob.sql
Rem SQL_PHASE: DBMSJOB
...
Rem     pxwong     08/12/13 - remove public execution grant
