...
package STANDARD AUTHID CURRENT_USER is              -- careful on this line; SED edit occurs!
  ...
  PRAGMA interface(c,'REM',"pesmod", 1);
  ...
  -- datetime is null
  PRAGMA interface(c,'IS NULL',"pes_dummy",15); -- time
  PRAGMA interface(c,'IS NULL',"pes_dummy",16); -- time wtz
  PRAGMA interface(c,'IS NULL',"pes_dummy",17); -- timestamp
  PRAGMA interface(c,'IS NULL',"pes_dummy",18); -- timestamp wtz
  PRAGMA interface(c,'IS NULL',"pes_dummy",19); -- timestamp lwtz
  PRAGMA interface(c,'IS NULL',"pes_dummy",20); -- interval ym
  PRAGMA interface(c,'IS NULL',"pes_dummy",21); -- interval ds
  ...
  PRAGMA interface(c,nvl,"peslcnl",18);       -- LOB NVL
  ...
  PRAGMA interface(c,'REM',"pesmodf", 2);
  PRAGMA interface(c,'MOD',"pesmodf", 2);
  PRAGMA interface(c,'REM',"pesmodd", 3);
  ...
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",15); -- time
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",16); -- time wtz
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",17); -- timestamp
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",18); -- timestamp wtz
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",19); -- timestamp lwtz
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",20); -- interval ym
  PRAGMA interface(c,'IS NOT NULL',"pes_dummy",21); -- interval ds
...
--  PRAGMA interface(c,nvl,"pes_dummy",9);       -- Ref Cursor
  ...
  PRAGMA interface(c,nvl,"pes_dummy",10);       -- Assoc_array
  PRAGMA interface(c,nvl,"pes_dummy",11);       -- Time
  PRAGMA interface(c,nvl,"pes_dummy",12);       -- Time-tz
  PRAGMA interface(c,nvl,"pes_dummy",13);       -- Timestamp
  PRAGMA interface(c,nvl,"pes_dummy",14);       -- Timestamp-tz
  PRAGMA interface(c,nvl,"pes_dummy",15);       -- Timestamp-ltz
  PRAGMA interface(c,nvl,"pes_dummy",16);       -- Intervalym
  PRAGMA interface(c,nvl,"pes_dummy",17);       -- Intervalds
--  PRAGMA interface(c,nvl,"pes_dummy",18);       -- Clob (Handled above, ICD)
  PRAGMA interface(c,nvl,"pes_dummy",19);       -- Opaque
  PRAGMA interface(c,nvl,"pes_dummy",20);       -- Binaryfloat
  PRAGMA interface(c,nvl,"pes_dummy",21);       -- Binarydouble
  PRAGMA interface(c,nvl,"pes_dummy",22);       -- PLSInteger

  -- 47322: JSON
  PRAGMA interface(c," SYS$STANDARD_JSON","pes_dummy",1);
  ...
  pragma TIMESTAMP('2014-09-15:00:00:00');
end;
