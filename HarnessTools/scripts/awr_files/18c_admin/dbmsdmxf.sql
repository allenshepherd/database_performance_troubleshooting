...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsdmxf.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsdmxf.sql
Rem SQL_PHASE: DBMSDMXF
...
Rem    amozes      10/10/14 - project 36570: long identifiers
Rem    surman      12/29/13 - 13922626: Update SQL metadata
Rem    surman      03/27/12 - 13615447: Add SQL patching tags
Rem    pstengar    08/25/11 - bug 12770953: change set_transform() to accept
Rem                           clob expressions
Rem    mmcracke    01/11/11 - Add DESCRIBE_STACK which uses dbms_sql.desc_tab3
Rem    mmcracke    05/06/10 - proj 32331.1 support native double in DMF
...
CREATE OR REPLACE PACKAGE dbms_data_mining_transform AUTHID CURRENT_USER AS 
  ...
  TYPE
    COLUMN_LIST                    IS VARRAY(1000) OF dbms_quoted_id;
