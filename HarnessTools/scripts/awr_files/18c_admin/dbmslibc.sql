Rem
Rem $Header: rdbms/admin/dbmslibc.sql /main/3 2017/05/28 22:46:04 stanaya Exp $
Rem
Rem dbmslibc.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/dbmslibc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/dbmslibc.sql
