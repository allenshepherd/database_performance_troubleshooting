Rem
Rem $Header: rdbms/admin/spdtab.sql /main/25 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem spdtab.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/spdtab.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/spdtab.sql
...
drop table  PERFSTAT.STATS$IOSTAT_FUNCTION_DETAIL;
