Rem
Rem $Header: rdbms/admin/xsu111.sql /main/19 2017/05/28 22:46:14 stanaya Exp $
Rem
Rem xsu111.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/xsu111.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/xsu111.sql
...
Rem    yiru        05/04/17 - bug 25070408:drop synonym XS$CACHE_DELETE
Rem    rbolarr     06/04/15 - Bug 17871008: Set default tablespace for XS$NULL
Rem    mkandarp    03/20/12 - 13683150 : select from resource_view use index
Rem                           hint
Rem    yiru        09/07/11 - Add calling xsu112.sql to drop xmlindex
Rem    yiru        05/13/10 - Remove calling xsu112.sql
...
Rem    yiru        12/11/08 - fix potential problems with data security schema
Rem    jsamuel     09/11/08 - fix lrg 3599584 ignore upgrade error
Rem    snadhika    06/15/08 - upgrade changes for new structured xmlindex 
Rem    yiru        03/13/08 - add 11.2 upgrade
