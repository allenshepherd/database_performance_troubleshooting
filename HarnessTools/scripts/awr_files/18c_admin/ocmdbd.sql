Rem
Rem $Header: emll/admin/scripts/ocmdbd.sql /main/28 2014/09/17 09:20:35 dkuhn Exp $
Rem
Rem ocmdbd.sql
Rem
...
Rem SQL_SOURCE_FILE: emll/admin/scripts/ocmdbd.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/ocmdbd.sql
Rem SQL_PHASE: OCMDBD
