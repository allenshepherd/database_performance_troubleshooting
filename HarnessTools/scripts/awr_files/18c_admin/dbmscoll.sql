Rem
Rem $Header: rdbms/admin/dbmscoll.sql /main/8 2014/02/20 12:45:44 surman Exp $
Rem
Rem dbmscoll.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmscoll.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmscoll.sql
Rem SQL_PHASE: DBMSCOLL
