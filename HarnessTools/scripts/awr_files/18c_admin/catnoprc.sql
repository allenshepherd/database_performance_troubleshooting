rem 
rem $Header: rdbms/admin/catnoprc.sql /main/3 2017/05/28 22:46:03 stanaya Exp $ noprctrg.sql 
rem 
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catnoprc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catnoprc.sql
