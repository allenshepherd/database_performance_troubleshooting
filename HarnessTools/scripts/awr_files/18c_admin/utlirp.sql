Rem
Rem $Header: rdbms/admin/utlirp.sql /main/13 2017/03/20 12:21:12 raeburns Exp $ 
Rem
Rem utlirp.sql
Rem
...
Rem      * set serveroutput must be set to off before invoking this script
Rem        otherwise deadlocks and internal errors may result.
Rem
Rem    BEGIN SQL_FILE_METADATA 
Rem    SQL_SOURCE_FILE: rdbms/admin/utlirp.sql 
Rem    SQL_SHIPPED_FILE: rdbms/admin/utlirp.sql 
...
Rem    raeburns    03/09/17 - Bug 25616909: Use UTILITY for SQL_PHASE
...
Rem Validate lbac_events package
@@olsrle
