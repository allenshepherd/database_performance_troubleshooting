Rem
Rem $Header: rdbms/admin/catnoap.sql /main/2 2017/05/28 22:46:02 stanaya Exp $
Rem
Rem catnoap.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catnoap.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catnoap.sql
