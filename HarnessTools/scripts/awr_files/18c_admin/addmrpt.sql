Rem
Rem $Header: rdbms/admin/addmrpt.sql /main/3 2017/05/28 22:46:00 stanaya Exp $
Rem
Rem addmrpt.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/addmrpt.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/addmrpt.sql
