rem 
rem $Header: rdbms/admin/utltkprf.sql /main/4 2017/05/28 22:46:13 stanaya Exp $ 
rem 
Rem NAME
REM    UTLTKPRF.SQL
Rem FUNCTION
...
Rem    SQL_SOURCE_FILE: rdbms/admin/utltkprf.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/utltkprf.sql
