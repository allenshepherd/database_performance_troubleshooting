Rem
Rem $Header: rdbms/admin/catdbfus.sql /main/11 2015/03/11 21:07:42 svaziran Exp $
Rem
Rem catdbfus.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/catdbfus.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/catdbfus.sql
Rem SQL_PHASE: CATDBFUS
...
Rem    svaziran    03/05/15 - 20652654: support for long identifiers
...
execute CDBView.create_cdbview(false,'SYS','DBA_FEATURE_USAGE_STATISTICS','CDB_FEATURE_USAGE_STATISTICS');
grant select on SYS.CDB_FEATURE_USAGE_STATISTICS to select_catalog_role
/
create or replace public synonym CDB_FEATURE_USAGE_STATISTICS for SYS.CDB_FEATURE_USAGE_STATISTICS
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_HIGH_WATER_MARK_STATISTICS','CDB_HIGH_WATER_MARK_STATISTICS');
grant select on SYS.CDB_HIGH_WATER_MARK_STATISTICS to select_catalog_role
/
create or replace public synonym CDB_HIGH_WATER_MARK_STATISTICS for SYS.CDB_HIGH_WATER_MARK_STATISTICS
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_CPU_USAGE_STATISTICS','CDB_CPU_USAGE_STATISTICS');
grant select on SYS.CDB_CPU_USAGE_STATISTICS to select_catalog_role
/
create or replace public synonym CDB_CPU_USAGE_STATISTICS for SYS.CDB_CPU_USAGE_STATISTICS
/
