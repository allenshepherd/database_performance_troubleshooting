Rem
Rem $Header: rdbms/admin/catlibc.sql /main/5 2017/05/28 22:46:01 stanaya Exp $
Rem
Rem catlibc.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catlibc.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catlibc.sql
