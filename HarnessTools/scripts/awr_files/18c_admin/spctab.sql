Rem
Rem $Header: rdbms/admin/spctab.sql /main/56 2017/05/28 22:46:10 stanaya Exp $
Rem
Rem spctab.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/spctab.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/spctab.sql
...
Rem    pjotawar    09/16/16 - Bug 23481673 Support Integrated Replicat 
Rem    zhefan      11/06/14 - Bug #19933671
Rem    pmurthy     02/20/14 - To Fix Bug - 18284201 and 18273117
Rem    kchou       10/30/13 - Bug# 17504669: Add New Column
Rem                             remaster_type to STATS$DYNAMIC_REMASTER_STATS
Rem    shsong      06/29/11 - shsong 06/28/11 - Bug 12702106: display
Rem                           v$IOSTAT_FUNCTION_DETAIL
Rem    traney      04/06/11 - 35209: long identifiers dictionary upgrade
...
/* Prompt ... XXX kchou XXX Creating Table STATS$DYNAMIC_REMASTER_STATS... */
...
,constraint STATS$DYNAMIC_REM_STATS_PK primary key 
     (snap_id, dbid, instance_number, remaster_type)
 using index tablespace &&tablespace_name
   storage (initial 1m next 1m pctincrease 0)
...
/*  Prompt ... XXX kchou XXX Creating Public Synonym STATS$DYNAMIC_REMASTER_STATS... */
...
create public synonym  STATS$IOSTAT_FUNCTION_DETAIL for
