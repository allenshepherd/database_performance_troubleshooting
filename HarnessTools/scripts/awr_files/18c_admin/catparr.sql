Rem
Rem $Header: rdbms/admin/catparr.sql /main/29 2017/05/28 22:46:03 stanaya Exp $
Rem
Rem catclustdb.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/catparr.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/catparr.sql
