Rem
Rem $Header: rdbms/admin/mgdus.sql /main/4 2017/05/28 22:46:07 stanaya Exp $
Rem
Rem mgdms.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/mgdus.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/mgdus.sql
Rem    SQL_PHASE: MGDUS
