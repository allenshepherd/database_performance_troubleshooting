Rem
Rem $Header: rdbms/admin/dbmsuadv.sql /main/7 2017/03/24 09:42:26 vinbhat Exp $
Rem
Rem dbmsuadv.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsuadv.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsuadv.sql
Rem SQL_PHASE: DBMSUADV
...
Rem    vinbhat     02/24/17 - Bug 24669652: make dbms_undo_adv invokers right
...
CREATE OR REPLACE PACKAGE dbms_undo_adv 
 authid current_user
IS
