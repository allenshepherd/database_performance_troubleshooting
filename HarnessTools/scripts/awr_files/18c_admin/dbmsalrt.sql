rem 
rem $Header: rdbms/admin/dbmsalrt.sql /main/13 2014/02/20 12:45:48 surman Exp $ 
rem 
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsalrt.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsalrt.sql
Rem SQL_PHASE: DBMSALRT
