Rem
Rem $Header: emll/admin/scripts/grntocmtabaccess.sql /main/8 2014/09/17 09:20:35 dkuhn Exp $
Rem
...
Rem    dkuhn       09/08/14 - add 12gR2 check
Rem    davili      07/18/13 - XbranchMerge davili_bug-16909807 from
Rem                           st_emll_10.3.8.1
Rem    ckalivar    07/16/13 - increase size of g_version_category to
Rem                           accommodate longer VERSION_10L string
...
/
 ...
 DECLARE
   l_is_cdb VARCHAR2(5) := 'NO';
   g_version_category VARCHAR2(15) := NULL;
