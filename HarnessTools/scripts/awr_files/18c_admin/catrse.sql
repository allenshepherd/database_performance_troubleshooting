Rem
Rem $Header: rdbms/admin/catrse.sql /main/5 2014/02/20 12:45:55 surman Exp $
Rem
Rem catrse.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/catrse.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/catrse.sql
Rem SQL_PHASE: CATRSE
...
execute CDBView.create_cdbview(false,'SYS','DBA_RECOVERABLE_SCRIPT','CDB_RECOVERABLE_SCRIPT');
grant select on SYS.CDB_RECOVERABLE_SCRIPT to select_catalog_role
/
create or replace public synonym CDB_RECOVERABLE_SCRIPT for SYS.CDB_RECOVERABLE_SCRIPT
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_RECOVERABLE_SCRIPT_HIST','CDB_RECOVERABLE_SCRIPT_HIST');
grant select on SYS.CDB_RECOVERABLE_SCRIPT_HIST to select_catalog_role
/
create or replace public synonym CDB_RECOVERABLE_SCRIPT_HIST for SYS.CDB_RECOVERABLE_SCRIPT_HIST
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_RECOVERABLE_SCRIPT_PARAMS','CDB_RECOVERABLE_SCRIPT_PARAMS');
grant select on SYS.CDB_RECOVERABLE_SCRIPT_PARAMS to select_catalog_role
/
create or replace public synonym CDB_RECOVERABLE_SCRIPT_PARAMS for SYS.CDB_RECOVERABLE_SCRIPT_PARAMS
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_RECOVERABLE_SCRIPT_BLOCKS','CDB_RECOVERABLE_SCRIPT_BLOCKS');
grant select on SYS.CDB_RECOVERABLE_SCRIPT_BLOCKS to select_catalog_role
/
create or replace public synonym CDB_RECOVERABLE_SCRIPT_BLOCKS for SYS.CDB_RECOVERABLE_SCRIPT_BLOCKS
/
...
execute CDBView.create_cdbview(false,'SYS','DBA_RECOVERABLE_SCRIPT_ERRORS','CDB_RECOVERABLE_SCRIPT_ERRORS');
grant select on SYS.CDB_RECOVERABLE_SCRIPT_ERRORS to select_catalog_role
/
create or replace public synonym CDB_RECOVERABLE_SCRIPT_ERRORS for SYS.CDB_RECOVERABLE_SCRIPT_ERRORS
/
