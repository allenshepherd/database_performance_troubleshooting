...
Rem     skwong     07/20/01 -  Add NCHAR support
...
function title(ctitle in varchar2 character set any_cs) return varchar2 character set ctitle%charset;
         /* No attributes in HTML 3.0 spec as of 6/7/95 */
...
/* HEAD Related elements tags */
procedure title  (ctitle in varchar2 character set any_cs)                      ;
...
procedure style(cstyle in varchar2 character set any_cs)                ;
...
procedure address(cvalue       in varchar2 character set any_cs,
                  ...
                  cclear       in varchar2 DEFAULT NULL,
                  cattributes  in varchar2 DEFAULT NULL)   ;
procedure comment(ctext in varchar2 character set any_cs)                       ;
...
procedure nobr(ctext in varchar2 character set any_cs);
procedure wbr;
procedure center(ctext in varchar2 character set any_cs);
...
procedure get_download_files_list(sFilesList out varchar2,
  ...
  -- Output Procedures
-- skwong: Added "character set any_cs"
...
-- skwong: Added "character set any_cs"
procedure prn (cbuf in varchar2 character set any_cs DEFAULT NULL);
procedure prn (dbuf in date);
procedure prn (nbuf in number);

  -- Abbrev call to print()
-- skwong: Added "character set any_cs"
procedure p (cbuf in varchar2 character set any_cs DEFAULT NULL);
...
procedure prints(ctext in varchar2 character set any_cs);
procedure ps(ctext in varchar2 character set any_cs);
procedure escape_sc(ctext in varchar2 character set any_cs);
