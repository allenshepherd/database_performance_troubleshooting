Rem
Rem $Header: rdbms/admin/dbmsidxu.sql /main/8 2014/02/20 12:45:54 surman Exp $
Rem
Rem dbmsidxu.sql
Rem
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmsidxu.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmsidxu.sql
Rem SQL_PHASE: DBMSIDXU
...
Rem    vraparla    07/10/12 - 14221012: Add Forced PDDL dop to all dbms index
