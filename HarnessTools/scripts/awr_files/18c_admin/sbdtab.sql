Rem
Rem $Header: rdbms/admin/sbdtab.sql /main/7 2017/05/28 22:46:09 stanaya Exp $
Rem
Rem sbdtab.sql
Rem
...
Rem    SQL_SOURCE_FILE: rdbms/admin/sbdtab.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/sbdtab.sql
...
drop table  STDBYPERF.STATS$IOSTAT_FUNCTION_DETAIL;
