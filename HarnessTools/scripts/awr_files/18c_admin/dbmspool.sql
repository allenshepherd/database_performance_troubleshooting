rem 
rem $Header: rdbms/admin/dbmspool.sql /main/17 2016/09/21 06:31:06 kquinn Exp $ 
rem 
...
Rem SQL_SOURCE_FILE: rdbms/admin/dbmspool.sql
Rem SQL_SHIPPED_FILE: rdbms/admin/dbmspool.sql
Rem SQL_PHASE: DBMSPOOL
...
Rem     kquinn     07/20/16  - 23127945: add support for editions
Rem     surman     12/29/13  - 13922626: Update SQL metadata
Rem     surman     03/27/12  - 13615447: Add SQL patching tags
Rem     jaeblee    02/03/11  - markhot does not raise for non-existing object
...
create or replace package dbms_shared_pool is
  ...
  procedure keep(schema varchar2, objname varchar2, namespace number,
                 heaps number, edition_name varchar2 DEFAULT null);
  ...
  --    edition_name
  --      This is an optional parameter. When it is specified it is used to 
  --      denote the name of the edition that the target object resides in.
  --  Exceptions:
  --      an exception will be raised if the named object cannot be found.
  ...
  --      denote the name of the edition that the target object resides in.
  --  Exceptions:
  --      an exception will be raised if the namespace passed in is invalid.
  ...
  --      If TRUE (default), mark the object hot on all RAC instances.
  --  Exceptions:
  --      an exception will be raised if the namespace or hash value
