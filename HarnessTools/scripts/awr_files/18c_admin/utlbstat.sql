rem 
rem $Header: rdbms/admin/utlbstat.sql /main/11 2017/05/28 22:46:12 stanaya Exp $ bstat.sql 
rem 
...
Rem    SQL_SOURCE_FILE: rdbms/admin/utlbstat.sql
Rem    SQL_SHIPPED_FILE: rdbms/admin/utlbstat.sql
